...
head(quakes,8)
tail(quakes,8)
plot(quakes$long,quakes$depth)

names(quakes)
quakes[,c(1,4)]

par(mfrow=c(2,3),mar=c(1,2,1,2),las=0,bty="o")
barplot(quakes$depth,main="Barplot",col="blue",horiz=T,axes=F)
hist(quakes$long,main="histogram",col="blue",axes=T)
boxplot(quakes$mag,main="Boxplot",col="blue",axes=T)
plot(density(quakes$lat))
boxplot(quakes[1:5])
boxplot(quakes$mag,main="Boxplot",horizontal=T,col="blue",axes=T)
